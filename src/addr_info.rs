// Based on https://github.com/linkerd/linkerd2-proxy/blob/release/v2.187.0/linkerd/proxy/transport/src/orig_dst.rs
//
//                                  Apache License
...
//
//    Copyright 2022 linkerd2-proxy Contributors
//
